...
class MenTopsAdapter(val context: Activity): RecyclerView.Adapter<MenTopsAdapter.MenTopsViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MenTopsViewHolder {
        return MenTopsViewHolder(LayoutInflater.from(parent.context).inflate(R.layout.layout_category_recyclerview, parent, false))
    }

    override fun onBindViewHolder(holder: MenTopsViewHolder, position: Int) {
    ...
    inner class MenTopsViewHolder(itemView: View): RecyclerView.ViewHolder(itemView), View.OnClickListener
    {
        init {
