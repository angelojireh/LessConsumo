...
class BagsAdapter(val context: Activity): RecyclerView.Adapter<BagsAdapter.BagsViewHolder>() {
    ...
    inner class BagsViewHolder(itemView: View): RecyclerView.ViewHolder(itemView), View.OnClickListener
    {
        init {
