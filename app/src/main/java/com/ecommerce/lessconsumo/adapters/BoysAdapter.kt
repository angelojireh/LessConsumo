...
class BoysAdapter(val context: Activity): RecyclerView.Adapter<BoysAdapter.BoysViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): BoysViewHolder {
        return BoysViewHolder(LayoutInflater.from(parent.context).inflate(R.layout.layout_category_recyclerview, parent, false))
    }

    override fun onBindViewHolder(holder: BoysViewHolder, position: Int) {
    ...
    inner class BoysViewHolder(itemView: View): RecyclerView.ViewHolder(itemView), View.OnClickListener
    {
        init {
