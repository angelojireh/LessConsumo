...
class ShoesAdapter(val context: Activity): RecyclerView.Adapter<ShoesAdapter.ShoesViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ShoesViewHolder {
        return ShoesViewHolder(LayoutInflater.from(parent.context).inflate(R.layout.layout_category_recyclerview, parent, false))
    }
    ...
    inner class ShoesViewHolder(itemView: View): RecyclerView.ViewHolder(itemView), View.OnClickListener
    {
        init {
