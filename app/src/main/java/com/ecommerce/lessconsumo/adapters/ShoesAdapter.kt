...
class ShoesAdapter(val shoes: ArrayList<String>) : RecyclerView.Adapter<ShoesAdapter.ViewHolder>() {
    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        // val testing: TextView = itemView.findViewById(R.id.testing)
        val shoes_price: TextView = itemView.findViewById(R.id.newarrival_price)
    }

    override fun onCreateViewHolder(
            parent: ViewGroup,
            viewType: Int
    ): ShoesAdapter.ViewHolder {
    ...
    override fun onBindViewHolder(holder: ShoesAdapter.ViewHolder, position: Int) {
        ...
        holder.shoes_price.text = shoes[position]
    }
