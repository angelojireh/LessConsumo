...
class GirlsAdapter(val context: Activity): RecyclerView.Adapter<GirlsAdapter.GirlsViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): GirlsViewHolder {
        return GirlsViewHolder(LayoutInflater.from(parent.context).inflate(R.layout.layout_category_recyclerview, parent, false))
    }
    ...
    inner class GirlsViewHolder(itemView: View): RecyclerView.ViewHolder(itemView), View.OnClickListener
    {
        init {
