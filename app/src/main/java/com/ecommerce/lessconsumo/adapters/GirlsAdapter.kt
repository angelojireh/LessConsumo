...
class GirlsAdapter(val girls: ArrayList<String>) : RecyclerView.Adapter<GirlsAdapter.ViewHolder>() {
    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        // val testing: TextView = itemView.findViewById(R.id.testing)
        val girls_price: TextView = itemView.findViewById(R.id.newarrival_price)
    }

    override fun onCreateViewHolder(
            parent: ViewGroup,
            viewType: Int
    ): GirlsAdapter.ViewHolder {
    ...
    override fun onBindViewHolder(holder: GirlsAdapter.ViewHolder, position: Int) {
        ...
        holder.girls_price.text = girls[position]
    }
