...
class TopsAdapter(val context: Activity): RecyclerView.Adapter<TopsAdapter.TopsViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): TopsViewHolder {
        return TopsViewHolder(LayoutInflater.from(parent.context).inflate(R.layout.layout_category_recyclerview, parent, false))
    }
    ...
    inner class TopsViewHolder(itemView: View): RecyclerView.ViewHolder(itemView), View.OnClickListener
    {
        init {
