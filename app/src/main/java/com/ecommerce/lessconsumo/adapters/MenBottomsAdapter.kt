...
class MenBottomsAdapter(val context: Activity): RecyclerView.Adapter<MenBottomsAdapter.MenBottomsViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MenBottomsViewHolder {
        return MenBottomsViewHolder(LayoutInflater.from(parent.context).inflate(R.layout.layout_category_recyclerview, parent, false))
    }

    override fun onBindViewHolder(holder: MenBottomsViewHolder, position: Int) {
    ...
    inner class MenBottomsViewHolder(itemView: View): RecyclerView.ViewHolder(itemView), View.OnClickListener
    {
        init {
