...
class MenBottomsAdapter: RecyclerView.Adapter<MenBottomsAdapter.MenBottomsViewHolder>() {
    ...
    class MenBottomsViewHolder(itemView: View): RecyclerView.ViewHolder(itemView)
    {
